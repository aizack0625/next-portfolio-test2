          ...
          <div className="flex flex-col md:flex-row items-center gap-28">
            ...
            <div className="w-full md:w-1/2 space-y-4 cyber-text">
              ...
              <p className="leading-relaxed cyber-paragraph">
                1999年生まれ<br />
                高校時代にC言語を学び、自分で入力したコードでシステムを動かせることでプログラミングに興味を持ちました。現在は職業訓練でHTML,CSS,JapaScript,TypeScript,React,Next.jsを学んでおり、将来はwebサイトなどをつくるフロントエンドエンジニアになりたいと思っています。<br />
